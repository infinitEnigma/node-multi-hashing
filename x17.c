...
int x17_test(unsigned char *pdata, const unsigned char *ptarget, uint32_t nonce)
{
...
void x17_regenhash(struct work *work)
{
  uint32_t data[20];
...
bool scanhash_x17(struct thr_info *thr, const unsigned char __maybe_unused *pmidstate,
